    ...
    <div>
      ...
      >
        ...
        <div className=" flex flex-row justify-between items-center px-32 mx-auto">
          ...
          <img src="./designs/design2.png" alt="" className=" h-64 rounded-sm filter grayscale hover:filter-none cursor-pointer" />
          </a>
          ...
          <img src="./designs/design1.png" alt="" className=" h-72 rounded-sm mx-6 filter grayscale hover:filter-none cursor-pointer"/>
          </a>
          ...
          <img src="./designs/design3.png" alt="" className=" h-64 rounded-sm filter grayscale hover:filter-none cursor-pointer"/>
          </a>
        </div>
      </div>
    </div>
