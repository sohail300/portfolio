...
const Contact = () => {
  return (
    <div
      className=" flex flex-col justify-center items-center z-0 px-4 py-8 lg:px-8"
      id="contact"
      style={{
        backgroundImage:
    ...
    >
      ...
      >
        ...
        <div className=" flex flex-row items-center justify-center text-center mt-2 heading">
          <PlaceIcon className=" mr-1 text-white" fontSize="small" />
          Dhanbad, Jharkhand, India
          <ReactCountryFlag countryCode="IN" svg className=" ml-2" />
        </div>
        <div
