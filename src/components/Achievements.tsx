    ...
    <div>
      ...
      >
        ...
        <div className=" flex flex-row justify-between items-center mx-auto">
          ...
          <img src="https://res.cloudinary.com/dwuzfbivo/image/upload/f_auto/v1711872069/portfolio/achievement/achievement1_vpcxw2.png" alt="" className=" h-64 rounded-sm cursor-pointer" />
          </a>
          ...
          <img src="https://res.cloudinary.com/dwuzfbivo/image/upload/f_auto/v1711872069/portfolio/achievement/achievement2_jtzp8v.png" alt="" className=" h-64 rounded-sm mx-6 cursor-pointer"/>
          </a>
          ...
          <img src="https://res.cloudinary.com/dwuzfbivo/image/upload/f_auto/v1711872069/portfolio/achievement/achievement3_qfzqnu.png" alt="" className=" h-64 rounded-sm cursor-pointer"/>
          </a>
        </div>
        </div>
    </div>
