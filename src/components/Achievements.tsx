    ...
    <div>
      ...
      >
        ...
        <div className=" flex flex-row justify-between items-center mx-auto">
          ...
          <img src="./achievement1.png" alt="" className=" h-64 rounded-sm cursor-pointer" />
          </a>
          ...
          <img src="./achievement2.png" alt="" className=" h-64 rounded-sm mx-6 cursor-pointer"/>
          </a>
          ...
          <img src="./achievement3.png" alt="" className=" h-64 rounded-sm cursor-pointer"/>
          </a>
        </div>
        </div>
    </div>
